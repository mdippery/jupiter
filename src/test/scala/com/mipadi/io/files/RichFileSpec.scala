...
class RichFileSpec extends FlatSpec with Matchers {
  ...
  val pDir = FileSystems.getDefault.getPath("src", "main", "scala", "com", "mipadi", "io")
  ...
  it should "be equal to itself" in {
    ...
    val pDir2 = FileSystems.getDefault.getPath("src", "main", "scala", "com", "mipadi", "io")
    pDir should === (pDir)
    pDir should === (pDir2)
  }
  ...
  it should "have a path property" in {
    ...
    pDir.path should be ("src/main/scala/com/mipadi/io")
  }

  it should "have an absolutePath property" in {
    dir.absolutePath.endsWith("src/main/scala/com/mipadi/io") should be (true)
    pDir.absolutePath.endsWith("src/main/scala/com/mipadi/io") should be (true)
  }
